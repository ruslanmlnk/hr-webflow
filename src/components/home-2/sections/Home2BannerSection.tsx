      ...
      <div className="w-layout-blockcontainer base-container w-container">
        <div className="home-2-banner-wrapper">
          <div className="home-2-banner-content-wrapper">
            <div data-w-id="840c6250-2090-e03d-0df8-cb882921525e" style={webflowStyles.opacity0} className="top-banner-block ix-fade-in">
            ...
            <h1 data-w-id="840c6250-2090-e03d-0df8-cb8829215265" style={webflowStyles.opacity0} className="banner-title aling-left ix-grow-in ix-delay-1">
              We find top talent<span className="grey-text"> for your business</span>
            </h1>
            <p data-w-id="840c6250-2090-e03d-0df8-cb882921526a" style={webflowStyles.opacity0} className="banner-paragraph width ix-fade-up ix-delay-2">We fill positions quickly and accurately — from mass hiring to executive search</p>
          ...
          <div className="right-elements-wrapper">
            ...
            <img src="images/subtract.svg" loading="lazy" style={webflowStyles.opacity0} data-w-id="2e66a02a-4e4a-37b3-79c1-81eb79fca035" alt="background image" className="bg-image ix-fade-in" />



            <div data-w-id="f06df3c2-59e4-6b20-51d3-3eb5e0d98e39" style={webflowStyles.opacity0} className="banner-blured-block left ix-fade-up ix-delay-1">
              <div className="banner-number-text">5,000+</div>
              <p className="small-paragraph">Candidates in the database</p>
            </div>
            <div data-w-id="caffce8b-ca9c-c9e4-cca8-29c6abcb36d7" style={webflowStyles.opacity0} className="banner-blured-block ix-fade-up ix-delay-2">
              <div className="banner-number-text">2,500+</div>
              <p className="small-paragraph">Closed vacancies</p>
            </div>
            <div data-w-id="ef1fab17-cdb9-0b7b-64c5-bb41750c21cc" style={webflowStyles.opacity0} className="circle-wrap ix-grow-in ix-delay-3">
