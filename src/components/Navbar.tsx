                ...
                <div className="nav-menu-wrapper">
                    ...
                    <nav role="navigation" className="nav-menu w-nav-menu">
                        <div className="tablet-menu">
                            <Link href="/home-1" className="brand-tablet w-nav-brand">
                                <img src="/images/logo.svg" loading="lazy" alt="logo" height="30" className="navbar-logo" />
                            </Link>
                        ...
                        <div className="menu-wrap">
                            ...
                            <div className="relative-navbar-block">
                                <div className="nav-dropdown">
                                    <Link href="/blog" className="nav-dropdown-toggle w-inline-block">
                            ...
                            <div className="search-shop-con tablet">
                                <Link href="/job-post" className="link-block w-inline-block">
                                    <div className="button-text">Job post</div>
                                </Link>
                                <Link href="/cv-post" className="primary-white-button w-inline-block">
                    ...
                    <div className="search-shop-con">
                        <Link href="/job-post" className="primary-button-black w-inline-block">
                            <div className="button-text">Job post</div>
                        </Link>
                        <Link href="/cv-post" className="primary-white-button w-inline-block">
                            <div className="white-button-text">CV post</div>
